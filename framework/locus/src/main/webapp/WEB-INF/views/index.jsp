...
<body>
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <div class="page-header position-relative">
            <h1>整体数据分析 <small><i class="icon-double-angle-right"></i> 整体情况; 数据分析</small></h1>
        </div><!--/page-header-->
        ...
        <div class="row-fluid">
            ...
            <div class="alert alert-block alert-info">
                ...
                <i class="icon-ok green"></i> 欢迎进入 <strong class="bar-yellow">胆道治疗信息管理系统 <small>(v1)</small></strong>,
                本系统为首个DEMO演示系统，请点击左边的菜单进行页面浏览.
            </div>
    ...
    <!-- inline scripts related to this page -->
            ...
            <script src="/resources/highchart/js/highcharts.js"></script>
            <script src="/resources/highchart/js/modules/exporting.js"></script>
